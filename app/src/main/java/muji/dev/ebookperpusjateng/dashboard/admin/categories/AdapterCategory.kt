...
import muji.dev.ebookperpusjateng.dashboard.admin.PdfListAdminActivity
import muji.dev.ebookperpusjateng.dashboard.admin.categories.models.ModelCategory
import muji.dev.ebookperpusjateng.databinding.RowCategoryBinding
...
class AdapterCategory : RecyclerView.Adapter<AdapterCategory.HolderCategory>, Filterable {
    ...
    override fun onBindViewHolder(holder: HolderCategory, position: Int) {
        ...
        holder.deleteBtn.setOnClickListener {
            ...
            builder.setTitle("Delete")
                .setMessage("Apa kamu yakin akan hapus data category?")
    ...
    // View Holder class hold/init UI views for row_category
